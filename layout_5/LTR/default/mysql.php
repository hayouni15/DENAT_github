...
define( 'DB_NAME', 'denat' ); // set database name
define( 'SEND_ERRORS_TO', 'hayouniabdessattar@gmail.com' ); //set email notification email address
    ...
    */
    ...
    public function update( $table, $variables = array(), $where = array(), $limit = '' )
    {
        ...
        foreach( $variables as $field => $value )
        {
            ...
            $updates[] = "`$field` = '".str_replace("'","\'",$value)."'";
        }
        $sql .= implode(', ', $updates);
        ...
        if( !empty( $where ) )
        {
            ...
            {
                $value = $value;
                $clause[] = "$field = '".str_replace("'","\'",$value)."'";
            }
