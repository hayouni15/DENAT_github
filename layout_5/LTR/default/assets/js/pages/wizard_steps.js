...
$(function() {
    ...
    $(".steps-basic").steps({
        ...
        onFinished: function (event, currentIndex) {
            ...
            $.post('/limitless/layout_5/LTR/default/denatphpcontroller.php', JSON.stringify(['ADD_PERSONNEL', {
            'P_LOCATION': $('#location').val(),
            'P_IMAGE':$('#username').val(),
            'P_POSITION': $('#position').val(),
            'P_NAME': $('#name').val(),
            'P_EMAIL': $('#email').val(),
            'P_PHONE': $('#phone').val(),
            'P_BIRTHDATE': $('#birthdate').val(),
            'P_ENGAGEMENT': $('#engagement').val(),
            'P_UNIVERSITY': $('#university').val(),
            'P_U_COUNTRY': $('#universitycountry').val(),
            'P_DEG_LEVEL': $('#degreelevel').val(),
            'P_SPECIALIZATION': $('#specialization').val(),
            'P_EDUCATION_PERIOD': $('#educationperiod').val(),
            'P_EDUCATION_LANGUAGE': $('#educatonlanguage').val(),
            'P_EXPERIENCE': $('#experience').val(),
            'P_EXP_DESC': $('#experiencedescription').val(),
            'P_ADD_INFO': $('#additionalinfo').val(),
            'P_SEX': $('#sex').val(),
            'P_RANK': $('#rank').val()
